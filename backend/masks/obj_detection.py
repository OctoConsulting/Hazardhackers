...
input_bucket = 's3://hack-input/masks_input/{}'

output_bucket =  's3://hack-input/masks_output/{}'
...
# Apply model
apply_model = os.popen("python3 yolov5/detect.py --source /usr/src/app/yolov5/" + input_file + " --weights /usr/src/app/masks.pt").read()
print(apply_model)
